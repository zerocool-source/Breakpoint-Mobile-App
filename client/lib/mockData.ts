...
export const mockJobs: Job[] = [
  {
    ...
    priority: 'high',
    status: 'pending',
    photos: ['https://images.unsplash.com/photo-1564844536308-50b114a1d946?w=200&h=200&fit=crop', 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=200&h=200&fit=crop'],
  ...
  },
  {
    ...
    priority: 'normal',
    status: 'pending',
    photos: ['https://images.unsplash.com/photo-1575429198097-0414ec08e8cd?w=200&h=200&fit=crop'],
  ...
  },
  {
    ...
    priority: 'urgent',
    status: 'pending',
    photos: ['https://images.unsplash.com/photo-1572331165267-854da2b021aa?w=200&h=200&fit=crop', 'https://images.unsplash.com/photo-1576013551627-0cc20b96c2a7?w=200&h=200&fit=crop', 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=200&h=200&fit=crop'],
