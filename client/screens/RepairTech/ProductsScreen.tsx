      ...
      {selectedItems.length > 0 ? (
        ...
        >
          ...
          <ThemedText style={styles.cartButtonText}>
            Create Repair (${totalAmount.toFixed(2)})
          </ThemedText>
        </Pressable>
      ) : null}
      ...
      >
        <View style={[styles.modalContainer, { backgroundColor: theme.backgroundRoot }]}>
          <View style={[styles.modalHeader, { backgroundColor: theme.surface, paddingTop: insets.top }]}>
            ...
            <ThemedText style={styles.modalTitle}>Create Repair Estimate</ThemedText>
            <View style={{ width: 24 }} />
          </View>
          ...
          <ScrollView style={styles.modalContent} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.section}>
              <ThemedText style={styles.sectionTitle}>Items ({selectedItems.length})</ThemedText>
            ...
            <View style={[styles.totalSection, { backgroundColor: theme.surface }]}>
              <ThemedText style={styles.totalLabel}>Estimate Total</ThemedText>
          ...
          <View style={[styles.modalFooter, { backgroundColor: theme.surface, paddingBottom: insets.bottom + Spacing.md }]}>
            ...
            >
              <ThemedText style={styles.submitButtonText}>
                {isSubmitting ? 'Creating...' : 'Create Repair Estimate'}
              </ThemedText>
            </Pressable>
          </View>
        </View>
